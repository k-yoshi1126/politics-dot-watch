...
class BillOutline(Base):
    ...
    def __repr__(self):
        return (
            f"<BillOutline(submitSession={self.submitSession}, number={self.number})>"
        )
