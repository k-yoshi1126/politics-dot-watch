...
def main():
    ...
    parser.add_argument('--session', '-s', default='213', help='国会回次 (デフォルト: 213)')
    parser.add_argument('--max-bills', '-m', type=int, default=5, help='取得最大件数 (デフォルト: 5)')
    parser.add_argument('--headless', action='store_true', help='ヘッドレスモードで実行')
    parser.add_argument('--wait', '-w', type=int, default=2, help='リクエスト間隔(秒) (デフォルト: 2)')
