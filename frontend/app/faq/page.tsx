        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-sm text-left">このサービスは何ですか？</AccordionTrigger>
            ...
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-sm text-left">誰が運営していますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-sm text-left">利用料金はかかりますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-sm text-left">法案データはどこから取得していますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-sm text-left">法案の要約はどのように作成されていますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-6">
              <AccordionTrigger className="text-sm text-left">法案データはどのくらいの頻度で更新されますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-7">
              <AccordionTrigger className="text-sm text-left">アカウント登録は必要ですか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-8">
              <AccordionTrigger className="text-sm text-left">投票結果はどのように利用されますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-9">
              <AccordionTrigger className="text-sm text-left">一度投票した後で、投票内容を変更できますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
        ...
        <CardContent>
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-10">
              <AccordionTrigger className="text-sm text-left">法案に関する意見や議論はできますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-11">
              <AccordionTrigger className="text-sm text-left">不具合や改善要望はどこに報告すればよいですか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
            ...
            <AccordionItem value="item-12">
              <AccordionTrigger className="text-sm text-left">SNSでの共有はできますか？</AccordionTrigger>
              <AccordionContent className="text-sm leading-relaxed">
